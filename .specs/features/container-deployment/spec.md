...
| --- | --- | --- |
| DEP-01 | Backend production image | In Tasks |
| DEP-02 | Four Next.js production images | In Tasks |
| DEP-03 | Build-context exclusions and secret safety | In Tasks |
...
| DEP-07 | Liveness/readiness health checks | In Tasks |
